...
<?php $__env->startSection('print'); ?>
    <?php if(session()->has('department_name')): ?>
        ...
        <div id="printarea" style="line-height:1.25">
            ...
            <br><br>
            <span style="float:left"><?php echo e(\Carbon\Carbon::now()->format('d-m-Y')); ?></span><span >Dominican Queue Reservation System</span><span style="float:right"><?php echo e(\Carbon\Carbon::now()->format('h:i:s A')); ?></span>
        </div>
        <script>
