...
<div class="col m3 offset-m2 center-align" >
        <div class="row">
            <div class="card-panel center-align" style="margin-bottom:0">
                <!--<span style="font-size:0.25rem">{{ trans('messages.display.qn') }}</span><br>-->
                <span id="num0" style="font-size:3rem;color:red;font-weight:bold;line-height:1.5">{{ $data[0]['number'] }}</span><br>
                <!--<span style="font-size:0.75rem">{{ trans('messages.display.please') }} {{ trans('messages.display.proceed_to') }}</span><br>-->
                <span id="dname0" style="font-size:1.50rem; color:green;line-height:1.5;font-weight:bold">{{ $data[0]['name'] }}</span><br>
                <span id="cou0" style="font-size:1rem; color:black;line-height:1.5;font-weight:bold">{{ $data[0]['counter'] }}</span>
            </div>
        </div>
        ...
        <div class="row">
            <div class="card-panel center-align" style="margin-bottom:0">
                <!--<span style="font-size:0.25rem">{{ trans('messages.display.qn') }}</span><br>-->
                <span id="num1" style="font-size:3rem;color:red;font-weight:bold;line-height:1.5">{{ $data[1]['number'] }}</span><br>
                <!--<span style="font-size:0.75rem">{{ trans('messages.display.please') }} {{ trans('messages.display.proceed_to') }}</span><br>-->
                <span id="dname1" style="font-size:1.50rem; color:green;line-height:1.5;font-weight:bold">{{ $data[1]['name'] }}</span><br>
                <span id="cou1" style="font-size:1rem; color:black;line-height:1.5;font-weight:bold">{{ $data[1]['counter'] }}</span>
            </div>
        </div>
        ...
        <div class="row">
            <div class="card-panel center-align" style="margin-bottom:0">
                <!--<span style="font-size:0.25rem">{{ trans('messages.display.qn') }}</span><br>-->
                <span id="num2" style="font-size:3rem;color:red;font-weight:bold;line-height:1.5">{{ $data[2]['number'] }}</span><br>
                <!--<span style="font-size:0.75rem">{{ trans('messages.display.please') }} {{ trans('messages.display.proceed_to') }}</span><br>-->
                <span id="dname2" style="font-size:1.50rem; color:green;line-height:1.5;font-weight:bold">{{ $data[2]['name'] }}</span><br>
                <span id="cou2" style="font-size:1rem; color:black;line-height:1.5;font-weight:bold">{{ $data[2]['counter'] }}</span>
            </div>
        </div>

        <!--<div class="col m3">
            <div class="card-panel center-align" style="margin-bottom:0">
                <span style="font-size:1.25rem">{{ trans('messages.display.qn') }}</span><br>
                <span id="num3" style="font-size:5rem;color:red;font-weight:bold;line-height:1.5">{{ $data[3]['number'] }}</span><br>
                <span style="font-size:0.75rem">{{ trans('messages.display.please') }} {{ trans('messages.display.proceed_to') }}</span><br>
                <span id="dname3" style="font-size:2.25rem; color:green;line-height:1.5;font-weight:bold">{{ $data[3]['name'] }}</span><br>
                <span id="cou3" style="font-size:2rem; color:black;line-height:1.5;font-weight:bold">{{ $data[3]['counter'] }}</span>
            </div>
        </div>-->
</div>

<div class="row align-self-center" style="font-size:{{ $settings->size }}px;color:{{ $settings->color }}">
